...
def run_profile_check() -> AuditItem:
    ...
    return AuditItem(
        ...
        missing=[] if result.returncode == 0 else [
            "Widget provisioning profile must include group.com.lbs.shcoolhelper",
        ],
    )
...
def main() -> int:
    items: list[AuditItem] = [
        ...
        item_from_files("core_feature_surfaces", [
            "ios/SchoolHelper/Features/Setup/SetupView.swift",
            "ios/SchoolHelper/Features/Home/HomeView.swift",
            "ios/SchoolHelper/Features/Timetable/TimetableView.swift",
            "ios/SchoolHelper/Features/Meals/MealsView.swift",
            "ios/SchoolHelper/Features/Schedule/ScheduleView.swift",
            "ios/SchoolHelper/Features/Timer/TimerView.swift",
            "ios/SchoolHelper/Features/Settings/SettingsView.swift",
            "ios/SchoolHelper/Core/Networking/NEISClient.swift",
            "ios/SchoolHelper/Core/Repositories/SchoolRepository.swift",
        ]),
        item_from_files("regression_and_runtime_verifiers", [
            ...
            "ios/SchoolHelperUITests/SchoolHelperIOSUITests.swift",
