...
DERIVED_DATA_PATH="${DERIVED_DATA_PATH:-/tmp/misschool-ios-live-external-link-ui-test}"
...
XCODEBUILD_ARGS=(
  ...
  'OTHER_SWIFT_FLAGS=$(inherited) -DLIVE_UI_TEST_ENABLED -DEXTERNAL_LINK_TEST_ENABLED'
  test
)
